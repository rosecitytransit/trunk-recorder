...
| controlWarnUpdate       |          | 3.0               | number                                                      | How often (in seconds) the control channel decode rate should be logged when controlWarnRate is met. The default is *3*, and is only done at multiples of 3. |
